...
<head>
        ...
        <title>iWomen Administration</title>
    ...
    <body class="login-content">
        ...
        <div class="lc-block toggled" id="l-login">
            ...
            <form action="/administration" method="post">
                ...
                <div class="input-group m-b-20">
                    ...
                    <div class="fg-line">
                        <input name="username" type="text" class="form-control" value="" placeholder="Username" required>
                    </div>
                </div>
            ...
            <ul class="login-navigation hide">
                ...
                <li data-block="#l-forget-password"><button class="btn-primary btn-sm waves-effect waves-effect">Forgot Password?</button></li>
            </ul>
        </div>
        
        <!-- Register -->
        <div class="lc-block" id="l-register hide">
            <div class="input-group m-b-20">
                <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
                <div class="fg-line">
        ...
        <div class="lc-block" id="l-forget-password">
            ...
            <ul class="login-navigation">
                <!-- <li data-block="#l-login" class="bgm-green">Login</li>
                <li data-block="#l-register" class="bgm-red">Register</li> -->
                <li data-block="#l-login"><button class="btn-primary btn-sm waves-effect waves-effect">Login</button></li>
            </ul>
        </div>
        ...
        <script src="{{Request::root()}}/material-design/js/functions.js"></script>
        
    </body>

<!-- Mirrored from 192.185.228.226/projects/ma/1-5-1/jquery/login.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 11 Sep 2015 11:46:33 GMT -->
</html>