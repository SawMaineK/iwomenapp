...
@section('content')
    <div class="card">
        <div class="card-header ch-alt">
            <a class="btn btn-primary pull-right" href="{!! route('mutipleOptions.create') !!}">Add New</a>
            <h2>MutipleOptions <small></small></h2>
                ...
                $("#data-table-command").bootgrid({
                    ...
                    formatters: {
                        "commands": function(column, row) {
                            return "<a href='mutipleOptions/"+row.id+"/edit'><button type=\"button\" class=\"btn btn-icon command-edit\" data-row-id=\"" + row.id + "\"><span class=\"zmdi zmdi-edit\"></span></button></a> " + 
                                "<a href='mutipleOptions/"+row.id+"/delete'><button type=\"button\" class=\"btn btn-icon command-delete\" data-row-id=\"" + row.id + "\"><span class=\"zmdi zmdi-delete\"></span></button></a>";
                        }
                    }
                });
            });
